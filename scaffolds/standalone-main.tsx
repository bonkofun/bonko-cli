...
} from '@bonko/template-sdk/runtime-client';
...
card.style.cssText =
  'padding:24px;min-height:100%;box-sizing:border-box;background:#fff9ed;color:#292620;font-family:system-ui;overflow-wrap:anywhere';
